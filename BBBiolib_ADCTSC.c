 ...
 *
 */
static int BBBIO_set_range(int L_range, int H_range)
{
 ...
 */
void BBBIO_channel_status(int chn_ID ,int enable)
{
	unsigned int *reg = NULL;
 ...
 *
 */
void BBBIO_module_ctrl(unsigned int clkdiv)
{
	unsigned int *reg = NULL;
 ...
 *
 */
int BBBIO_channel_ctrl(unsigned int chn_ID, int mode, int open_dly, int sample_dly, int sample_avg, unsigned int *buf, unsigned int buf_size)
{
	unsigned int *reg = NULL;
 ...
 *
 */
unsigned int BBBIO_work(unsigned int fetch_size)
{
...
int BBBIO_Init()
{
	...
	*reg &= ~0x1 ;
	...
	BBBIO_module_ctrl(1);
	BBBIO_set_range(ADCRANGE_MIN_RANGE, ADCRANGE_MAX_RANGE);

        /* Default channel configure */
	BBBIO_channel_ctrl(BBBIO_ADC_AIN0, BBBIO_ADC_STEP_MODE_SW_ONE_SHOOT, 0, 1, BBBIO_ADC_STEP_AVG_1, NULL, 0);
	BBBIO_channel_ctrl(BBBIO_ADC_AIN1, BBBIO_ADC_STEP_MODE_SW_ONE_SHOOT, 0, 1, BBBIO_ADC_STEP_AVG_1, NULL, 0);
	BBBIO_channel_ctrl(BBBIO_ADC_AIN2, BBBIO_ADC_STEP_MODE_SW_ONE_SHOOT, 0, 1, BBBIO_ADC_STEP_AVG_1, NULL, 0);
	BBBIO_channel_ctrl(BBBIO_ADC_AIN3, BBBIO_ADC_STEP_MODE_SW_ONE_SHOOT, 0, 1, BBBIO_ADC_STEP_AVG_1, NULL, 0);
	BBBIO_channel_ctrl(BBBIO_ADC_AIN4, BBBIO_ADC_STEP_MODE_SW_ONE_SHOOT, 0, 1, BBBIO_ADC_STEP_AVG_1, NULL, 0);
	BBBIO_channel_ctrl(BBBIO_ADC_AIN5, BBBIO_ADC_STEP_MODE_SW_ONE_SHOOT, 0, 1, BBBIO_ADC_STEP_AVG_1, NULL, 0);
	BBBIO_channel_ctrl(BBBIO_ADC_AIN6, BBBIO_ADC_STEP_MODE_SW_ONE_SHOOT, 0, 1, BBBIO_ADC_STEP_AVG_1, NULL, 0);
